...
"DRN CODE FROM DRN REPO (JUST FOR TESTING)"
...
def train(train_loader, model, criterion, optimizer, epoch,writer=None,
    ...
    random_i = np.random.randint(0,len(train_loader),5).tolist()
    for i, (input, target) in enumerate(train_loader):
        ...
        if(i in random_i):
            writer.add_image('Ground Truth Mask #' + str(i), target)
            writer.add_image('Predicted Mask #' + str(i), target)
...
def train_seg(args):
    ...
    for i, train_batch in enumerate(dataset):
        ...
        train_loader = DataLoader(helper_dataset, batch_size=1,shuffle=True,num_workers=4)
    ...
    # define loss function (criterion) and pptimizer
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            train(train_loader, model, criterion, optimizer, epoch,writer1,
                eval_score=accuracy)
